...
date: "Last updated: 12 September 2025"
output:  
...
In this tutorial you’ll learn to **clean, transform, and merge data** into a single analysis-ready dataset.
...
**Part 1 - Setup**
- Download and explore the data for this tutorial.

**Part 2 – Building Skills**

- **2A. Base R functions in tidyverse** → summary stats, ranking, uniqueness  
- **2B. Advanced cleaning** → regex for string data  
- **2C. Working with time** → dates, weeks, missing values, lags & leads  
- **2D. Pivoting** → reshape between long ↔ wide formats  
- **2E. Merging** → joins (left, inner, full)

**Part 3 – Case Study & Exercises**

- Assemble a complete artist–country–week dataset  
- Aggregate to weekly level  
- Add trend variables  
- Merge in weather & socials  
- Handle missing data  
- Scale up with loops: plots & regressions  

__IMPORTANT:__ Recall that all of these concepts are covered in the accompanying textbook, available at https://dprep-book.hannesdatta.com. Please complete the reading of the corresponding chapter ("data engineering & databases") before working on this tutorial.
...
1. Open Positron and create a new project folder for this tutorial.
...
Click [here](https://github.com/hannesdatta/course-dprep/raw/refs/heads/main/material/tutorials/r-engineering/raw_data/week4_data.zip) to manually download the dataset. Alternatively, run the following R code to download and unzip the file automatically: 

```{r eval=TRUE, include=TRUE}
# downloading and unzipping the data
if (!file.exists('downloaded_data.zip')) {
  download.file('https://github.com/hannesdatta/course-dprep/raw/refs/heads/main/material/tutorials/r-engineering/raw_data/week4_data.zip', 'downloaded_data.zip')
...
# Part 2: Expanding our knowledge of R
...
## 2A) Applying base R functions in `tidyverse`
...
## 2B) Advanced Cleaning: Using Regular Expressions
...
## 2D) Pivoting Data: Reshaping from Long to Wide and Wide to Long  
...
## 2E) Merging Data: Combining Multiple Data Sources  
...
# Part 3: Case study and Exercises
...
```{r eval=T, webex.hide = 'Solutions',include=show_solutions}
library(tidyverse)
...
```{r eval=F, webex.hide = 'Solutions',include=show_solutions}
artists = unique(complete_data$artist)

...
- After class: complete [tutorial](https://dprep.hannesdatta.com/docs/modules/week3/tutorial/version-control.html) + review command line/terminal (e.g., [Datacamp, Mac & Windows](https://datacamp.com/courses/introduction-to-shell); [Mac Tutorial](https://generalassembly.github.io/prework/cl/#/))
...
- Curious? [Explore topics!](https://github.com/topics)
...
<br>
- __DO__ Today, we use "GitHub classroom" (so I can see what you're up to)
...
- Complete the [tutorial](https://dprep.hannesdatta.com/docs/modules/week3/tutorial/version-control) at home

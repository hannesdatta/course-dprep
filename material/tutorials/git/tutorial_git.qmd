...
# Excercise 4: logs
- Remove my_answers.txt
- Look up the hash of the commit which had the file usign git log
- Run git checkout <SHA> and inspect your directory. Is the my_answers.txt there again?

...
date: "Last updated: 25 August 2025 (+ minor bug fixes, 3 October 2025)"
output:  
...
```{r, webex.hide = 'Solutions to Exercise 3a', include=show_solutions}
# Exploring the range
...
```{r, echo = TRUE, webex.hide = 'Solutions to Exercise 4', message = FALSE, include=show_solutions}
# Good solution
# ------------- 
...
```{r, webex.hide = 'Solution to Exercise 5', include=show_solutions}
...
```{r, webex.hide = 'Solution to Exercise 7', eval = FALSE, include= show_solutions}
...
```{r, webex.hide = 'Incorrect solutions to Exercise 7', eval = FALSE, include = show_solutions}
...
```{r, webex.hide = 'Solution to Exercise 8', include = show_solutions}
...
```{r eval=TRUE, webex.hide = 'Solution to Exercise 9', include = show_solutions}

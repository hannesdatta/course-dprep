...
- __Exam prep:__ If you haven't been present in the Q&A last week, please watch the recording and review the exam information + example questions shared last week (&rarr; Canvas).
...
- Ready to use Git/versioning in a business setting
  - Clone repositories, switch branches (`git checkout BRANCHNAME` or `git switch BRANCHNAME`)
  - Know which files/directories to version, and which ones not
...
- All wrong
  - One "all" rule with all targets as prerequisites (correct: final products/files to be built)
  - Incomplete dependencies (correct: all input files + own source code per recipe)
  - Multiple Rscript execution commands per recipe (correct: write separate rules)


__Gradually build your makefile. Go in baby steps!__

---

## Any question about your projects?

__We can address your questions now!__

---

## Looking ahead: dPrep skills during your studies (I)
...
## Looking ahead: dPrep skills during your studies (II)

::: incremental
- Use "workflow thinking" for thesis!
  - But, be aware your skills are fresh, your thesis advisor likely has never heard about it! &rarr; use, teach, show how productive you are!
- Build your job market profile
  - Have a compelling about page on GitHub
  - "Pin" your best repositories (but don't call them `dprep-team-X`)
...
## Looking ahead: dPrep skills after your studies
...
- Become a linking pin between data science/engineering teams and "the business" (i.e., the 'core' business functions like product development, customer acquisition, etc.)
...
- Deadline for project coming up!
  - Remember: __test project__ on different computers and operating systems
...
- Re-watch my recording from last week (Q&A) & work through example questions (posted on Canvas)

## Exam

- Complete [shared cheat sheet](https://docs.google.com/document/d/1nLEkypEmP3dTkljidmAiGmHptm0Bfe44LnwaYUnkdnU/edit?usp=sharing)
  - Deadline to make your changes: 25 March 2026, 10am.
  - Page limit: 50 pages. Only one tab. 
- Check whether you can view the technical practice exam on TestVision
- Practice on Windows computers

---

## Next steps: Official course evaluation (I)

- Course evaluation has been immensely important to this course
  - This semester: edited tutorials 1-2; piloted setup to involve more lecturers
  - Last semester: wrote a book, overhauled all tutorials (e.g., `ggplot2` in week 2, advanced engineering in week 4)
...
## Next steps: Official course evaluation (II)
...
::: incremental
- How come not many of you attended the tutorials?

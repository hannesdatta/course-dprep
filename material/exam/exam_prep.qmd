...
*originally published on 26 September; updated on 28 September, slightly rewriting questions in line with the actual exam & adding the number of points per question)*
...
To receive points on this question, please create and upload one R file (.R) that performs the task as requested.

...
- 120-minute on-campus computer exam (328059-M-6; any students taking the resit for 328059-M-3, 180 minutes?)
...
- **Be familiar with your exam environment**:
  - Practice using **Windows**, Positron, and the command prompt (__not__ PowerShell; ideally Anaconda Prompt, sometimes GitBash).
- **Know how to manage files and directories**:
...
- **Make sure to know the basics of code management**:
  - Set working directories in Positron via `Session → Set Working Directory → To Source File Location`.
  - Revise code for clean (top-down!) execution. No useless code.

## Familiarize yourself with TestVision

- Know how to work with [TestVision](https://www.tilburguniversity.edu/students/studying/exams/e-assessment/testvision)
...
::: callout
- Please take the **technical practice exam**, which you can access *once* via [https://tiu.nu/testvision](https://tiu.nu/testvision).
- Please explore [TestVision’s generic practice exam](https://oefentoetsen.testvision.nl/online/fe/login_ot.htm?campagne=tlb_demo_eng&taal=2).
:::
...
zip))
- **One collective cheatsheet**
  - Drafted collaboratively in Google Docs, reviewed by the instructor, and shared as PDF.
  - [Link to the document](https://docs.google.com/document/d/1nLEkypEmP3dTkljidmAiGmHptm0Bfe44LnwaYUnkdnU/edit?usp=sharing)
...
- I will show you example cover pages now (see also PDF)
- Please review in advance: The cover page will be available on Canvas before the exam

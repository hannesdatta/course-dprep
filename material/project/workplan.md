...
{{< hint info >}}
**Deliverables** are submitted on Canvas. Please check Canvas for the due dates for each week. The course team will provide short feedback in line with the [grading rubric](/docs/other/dprep-project-rubric.pdf) at least a day before the next coaching session.
{{< /hint >}}

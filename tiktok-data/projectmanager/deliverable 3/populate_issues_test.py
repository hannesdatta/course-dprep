"""Test populator for deliverable 3 - touches ONE fork only.

Safety wrapper around the shared ``../populate.py`` for trying the
deliverable 3 checklist against a single fork before unleashing it on every
fork.
...
DELIVERABLE_LABEL = "deliverable 3"

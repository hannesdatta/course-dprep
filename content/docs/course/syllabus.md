...
- Students who have passed the course, but wish to retake the exam, can take the exam resit. The highest exam grade counts. The same assessment weights (team assignment, computer exam, submitting one's progress) also apply for the resit.

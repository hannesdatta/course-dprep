...
* Head over to [Tilburg Science Hub](https://tilburgsciencehub.com/building-blocks/configure-your-computer/automation-and-workflows/make/) and follow the make installation procedure for either Windows, Mac or Linux. Verify whether you installed make successfully by typing `make` in the terminal. 
* Also, make sure you can call R from the command prompt. On Mac and Linux, R is available from the command line by default. Windows user can follow the steps at the bottom of [this](https://tilburgsciencehub.com/building-blocks/configure-your-computer/statistics-and-computation/r/) page.
...
**Exercise 2**  
1. Create a new makefile (tip: use `touch makefile` in your terminal) and then open the file in a text editor. Add the two lines above and save the changes. Open your terminal and run `make`. What happens?  

...
\
**Exercise 1**     
Inspect the `mobility` data frame and describe the structure of the data set in your own words. What is the target unit of analysis? How are the measures grouped? How are variables operationalized? Do columns seem complete? Are there any values that do not make sense? Are “strings” properly encoded?

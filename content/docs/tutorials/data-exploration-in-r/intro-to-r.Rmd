...
With the help of the `read.csv()` function, we can now import the (2020) mobility data for the Netherlands into R. Download this [data set from Google](https://www.google.com/covid19/mobility/) (you have to unzip it first!), create a *new R script* in the same directory, and read in the data. 
...
country <- mobility %>% filter(city == "" & province == "")
province <- mobility %>% filter(city == "" & province != "")
city <- mobility %>% filter(city != "")
```

...
Click [here](https://github.com/hannesdatta/course-dprep/raw/refs/heads/new_week4/content/docs/modules/week4/tutorial/data/week4_data.zip) to manually download the dataset. Alternatively, run the following R code to download and unzip the file automatically: 
...
- **`grepl()`** → Detect patterns in text (**Find something**)  
- **`gsub()`** → Replace matched patterns with new values (**Replace something**)  
...
- Pivoting is **reversible**—you can always reshape data back if needed.  

...
Marketing analytics projects — whether for a thesis, a research study, or an analytics role — often involve messy, multi-source datasets, complex analyses, and the need for reproducibility. Small ad-hoc fixes might work for simple tasks, but they quickly break down in these larger, more demanding settings. Today’s datasets (e.g., scraped from the Internet)[^index-1] and advanced analytics (e.g., requiring high-performance computing) demand a structured, professional way of working.

[^index-1]: See, for example, the data sections in [Building a user panel of music consumption from Spotify](http://tiu.nu/spotify) and [Preparing a panel data set on electronics sales and marketing mix activities across thousands of brands](https://journals.sagepub.com/doi/10.1177/00222437211058102).

This course introduces you to the core principles to help you manage marketing analytics projects across the full research workflow: data exploration, preparation, analysis, and reporting.

### Learning goals

After successful completion of this course, you will be able to:

1.  Use GitHub (or similar tools) to manage empirical research projects following Scrum-inspired project-management practices, including planning, organizing, and coordinating work performed by team members and software agents.
2.  Use Git/GitHub (or similar tools) for versioning files and collaborating on privately shared and publicly available open-source repositories.
3.  Use R/RStudio and SQL to clean and transform data for analysis (e.g., aggregation, merging, de-duplication, reshaping, data conversions, and regular expressions).
4.  Use R/RStudio to generate automated reports and dynamic dashboards (e.g., for assessing data quality or reporting research findings).
5.  Use workflow-management tools to create and run portable, automated, and reproducible data pipelines.
6.  Critically assess when the use of large language models and software agents is appropriate, and use them effectively and responsibly through clear prompting, task specification, and verification of outputs.
...
-   **Tilburg University students**: Enrollment is possible with the approval of the instructor and your program coordinator. Please notify the course coordinator by **15 August 2026**.\
-   **External students**: You are welcome to audit this course. For admission, email a **brief research statement**, your **motivation** for joining, and your **CV** by **15 August 2026**.

**Notification:** Eligible candidates will be informed by **22 August 2026**.
:::
...
-   Students can use their own computer for the duration of this course (Windows, Mac, or Linux). Android/Chromebook/iOS devices are not supported. We recommend laptop with 8+ GB of RAM as we work with larger data sets requiring preprocessing capacity. The exam is held on campus, using Windows computers. Mac and Linux users are advised to practice on the on-campus computers before the exam.

## Teaching format

-   Blended learning: a mix of lecturers, tutorials and coaching sessions, mostly on-campus, and sometimes online or prerecorded
-   Learn state-of-the-art tools popular among scientists, marketing analysts, and data scientists (e.g., R/RStudio, GitHub, VS Code, `make`)

## Assessment

-   Team assignment (40%, out of which 20% are based on students' individual contributions, measured through their individual code contributions).
...
-   the final course grade (i.e., the weighted average of the following two components: (1) the team project, and (2) the exam; weights indicated above) is ≥ 5.5, and
...
-   If students have an exam grade higher or equal to 5.0 but fail the team project, their total course grade may be lower than 5.5, and hence students fail this course.
...
-   Stay up-to-date by checking the Canvas page of this course.
...
-   [dr. Hannes Datta](https://hannesdatta.com), Associate Professor at the Marketing Department of Tilburg University (**course coordinator & lectures**),
-   [Javier Torralba Flores](https://www.javiertorralba.com), PhD student at the Marketing Department of Tilburg University (**tutorials**), and
-   Jeroen Swolfs, M.Sc., Junior Lecturer at the Marketing Department of Tilburg University (**team project and coaching sessions**).

::: {.callout-note title=""}
Join Hannes' professional network on [LinkedIn](https://www.linkedin.com/in/hannes-datta/).
:::

<!--subscribe to his [YouTube Channel](https://youtube.com/c/hannesdatta), and start following him on [GitHub](https://github.com/hannesdatta).-->
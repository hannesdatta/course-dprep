...
3.  Use R/Positron and SQL to clean and transform data for analysis (e.g., aggregation, merging, de-duplication, reshaping, data conversions, and regular expressions).
4.  Use R/Positron to generate automated reports and dynamic dashboards (e.g., for assessing data quality or reporting research findings).
...
-   Learn state-of-the-art tools popular among scientists, marketing analysts, and data scientists (e.g., R/Positron, GitHub, VS Code, `make`)

## Assessment

-   Team assignment (40%; graded through a combination of team work and individual work contributions; see project grading guidelines).

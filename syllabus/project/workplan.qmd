...
- **Deliverables:**
  ...
  - For more details, see grading guidelines, specifically 1.2 (Repository Structure) and 1.3 (Way of working using GitHub).
...
- **Deliverables:**
  ...
  - For details, see grading guidelines, with an emphasis on 3.1 and 3.2 (Source code quality and degree of automation).

...
**Deliverables** are submitted on Canvas. Please check Canvas for the due dates for each week. The course team will provide short feedback in line with the grading rubric at least a day before the next coaching session.
:::
...
- **Deliverables:**
  - RMarkdown document (both `.md` and rendered as `.pdf`), with your research motivation and initial data exploration (see [grading rubric](dprep-project-rubric.pdf), 1.1 (Research Motivation) and 2.1 (Data Exploration)).
...
- **Deliverables:**
  ...
  - For more details, see [grading rubric](dprep-project-rubric.pdf), specifically 1.2 (Repository Structure) and 1.3 (Way of working using GitHub).
...
- **Deliverables:**
  - Updated GitHub repository, with an emphasis on 2.2 (Data Preparation) and 1.3 (Way of working using GitHub). For details, see [grading rubric](dprep-project-rubric.pdf).
...
- **Deliverables:**
  ...
  - For details, see [grading rubric](dprep-project-rubric.pdf), with an emphasis on 3.1 and 3.2 (Source code quality and degree of automation).

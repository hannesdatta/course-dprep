...
-   Create your own, end-to-end GitHub workflow based on a TikTok-style project pipeline (CSV + SQL inputs, feature branches, pull requests, and `make` automation). Fork that repository and collaboratively work on it with everyone.

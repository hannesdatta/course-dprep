...
On its own, R looks like a command-line interface, but most people use it through **Positron**. Positron is an integrated development environment (IDE) from Posit that provides a script editor, a console for running code, a viewer for data objects, and tools for plots and files. This makes Positron the natural starting point for most analysts.  
...
In Positron, it is best to organize your work as a **project**. A project is simply a folder that contains your data, scripts, and outputs. By opening your project folder in Positron, your code can refer to files relative to that location.  
...
You can type code directly into the console, but for real work you should save it in a script (`.R`). Scripts can be run line by line in Positron, or all at once from the terminal:
